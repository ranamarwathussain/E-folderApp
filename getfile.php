...
$select = "SELECT * FROM `storage` WHERE `fcode` = '".$_SESSION['faculty']."' and coursename='$coursename' and section='$coursesection' ORDER BY pattern ASC";
...
//We select the default I to run the output on the browser.
 $Outputpdf->Output('I', 'CourseFolder-fcode-'.$_SESSION['faculty'].'-cname-'.$coursename.'-section-'.$coursesection.'.pdf');
