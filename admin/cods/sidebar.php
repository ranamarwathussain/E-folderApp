   ...
   <button type="button" class="btn btn1">  <a class="navbar-brand" href="home.php">Home</a></button>
    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
         <button type="button" class="btn btn-success btn2"><a   href="codsdepartments.php"><p style="color: white;">Departments</p></a></button>
        </li>
          <li class="nav-item">
         <button type="button" class="btn btn-info btn2"><a   href="codscoordinators.php"><p style="color: white;">Coordinators</p></a></button>
        </li>
