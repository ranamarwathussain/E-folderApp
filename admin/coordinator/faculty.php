...
<body>
  ...
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"></span> Add Faculty</button>
...
<br /><br />
		...
		<table id = "table" class="table table-bordered">
			...
			<tbody>
				<?php
					$query = mysqli_query($conn, "SELECT * FROM `faculty` where createdby='".$_SESSION['user']."'") or die(mysqli_error());
				...
				?>
					<tr class="del_student<?php echo $fetch['fid']?>">
						...
						<td><center><button class="btn btn-warning" data-toggle="modal" data-target="#edit_modal<?php echo $fetch['fid']?>"><span class="glyphicon glyphicon-edit"></span> Edit</button> 
						<a href="deletefaculty.php?id=<?php echo $fetch['fcode']?>" ><button class="btn btn-danger btn-delete"  type="button"><span class="glyphicon glyphicon-trash"></span> Delete</button></center></a></td>
					</tr>
